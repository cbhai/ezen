                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex justify-end">
                                    @can('estimate_show')
                                        <a class="btn btn-sm btn-info mr-2" href="{{ route('admin.estimates.show', $estimate) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
                                    @can('estimate_edit')
                                        <a class="btn btn-sm btn-success mr-2" href="{{ route('admin.estimates.edit', $estimate) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan
                                    @can('estimate_delete')
                                        <button class="btn btn-sm btn-rose mr-2" type="button" wire:click="confirm('delete', {{ $estimate->id }})" wire:loading.attr="disabled">
                                            {{ trans('global.delete') }}
                                        </button>
                                    @endcan
                                </div>
