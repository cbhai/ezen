                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex justify-end">
                                    @can('branding_show')
                                        <a class="btn btn-sm btn-info mr-2" href="{{ route('admin.brandings.show', $branding) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
                                    @can('branding_edit')
                                        <a class="btn btn-sm btn-success mr-2" href="{{ route('admin.brandings.edit', $branding) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan
                                    @can('branding_delete')
                                        <button class="btn btn-sm btn-rose mr-2" type="button" wire:click="confirm('delete', {{ $branding->id }})" wire:loading.attr="disabled">
                                            {{ trans('global.delete') }}
                                        </button>
                                    @endcan
                                </div>
