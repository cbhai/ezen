                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex justify-end">
                                    @can('term_show')
                                        <a class="btn btn-sm btn-info mr-2" href="{{ route('admin.terms.show', $term) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
                                    @can('term_edit')
                                        <a class="btn btn-sm btn-success mr-2" href="{{ route('admin.terms.edit', $term) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan
                                    @can('term_delete')
                                        <button class="btn btn-sm btn-rose mr-2" type="button" wire:click="confirm('delete', {{ $term->id }})" wire:loading.attr="disabled">
                                            {{ trans('global.delete') }}
                                        </button>
                                    @endcan
                                </div>
