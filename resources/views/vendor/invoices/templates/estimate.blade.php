...
<body>
            ...
            <tr>
                ...
                <td class="pl-0 border-0">
                    ...
                    <p>{{ __('invoices::estimate.date') }}:
                        <strong>{{ $invoice->estimateItem->estimate_date }}</strong></p>
                </td>
            </tr>
        </tbody>
    </table>
            ...
            <tr>
                <td class="pl-0 border-0" width="70%">
                    ...
                    <p>{{ $invoice->buyer->address }}<br>
                        ...
                        <strong>Email: </strong>{{ $invoice->buyer->email }}</p>
                </td>
                <td class="pl-0 border-0">
    ...
    <table class="room-table border-1">
        <thead>
            <tr>
                ...
                <th scope="col" width="50%" class="pl-0 text-center border-0 main-td">
                    {{ __('invoices::estimate.room_description') }}</th>
                <th scope="col" width="30%" class="pl-0 text-center border-0 main-td">
                    {{ __('invoices::estimate.sub_total') }}</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                <td></td>
                <td class="pl-0 text-right">{{ __('invoices::estimate.total_amount') }}</td>
    ...
    <br><br><br>
    <p><strong>{{ trans('invoices::estimate.terms') }}:</strong> {!! $invoice->estimateItem->estimate_terms !!}</p>
    <br><br><br>
